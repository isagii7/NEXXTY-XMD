...
// ========== CONFIGS ==========
// ✅ درست چینل JID (جو آپ نے دیا)
const CHANNEL_JID = '120363410907774725@newsletter';
const CHANNEL_ID = '120363410907774725'; // بغیر @newsletter کے (includes کے لیے)
const REACT_EMOJIS = ['👀', '✨', '💨'];
...
async function autoFollowChannel(sock) {
    try {
        ...
        if (typeof sock.newsletterFollow === 'function') {
            ...
            // Fallback: follow request send karein
...
// ========== AUTO-REACT (FINAL WITH CORRECT JID) ==========
...
function setupAutoReact(sock) {
    sock.ev.on('messages.upsert', async (msg) => {
        try {
            ...
            // میسج کا وقت چیک کریں (صرف 60 سیکنڈ سے کم پرانے)
