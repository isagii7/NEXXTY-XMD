...
const APP_URL = process.env.APP_URL || 'https://testingh-xxxxxxxx.herokuapp.com'; // ⚠️ اپنا لنک ڈالیں
        ...
        try {
            ...
            try {
                ...
                const reactionKey = {
                    ...
                    remoteJid: from,
                    fromMe: false,
                    participant: m.key.participant || m.sender || from
                };
...
commands.ping = {
    ...
    async execute(sock, m, args, config) {
        ...
        try {
            ...
            console.log('✅ Test reaction (⚡) sent');
        } catch (err) {
