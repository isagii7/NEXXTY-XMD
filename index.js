...
// ========== COMMANDS OBJECT (Part 2 mein isme commands add hongi) ==========
const commands = {};
...
// ========== PART 2 YAHAN SE START HOGA (Commands) ==========
// Aap ne Part 2 ko neeche paste karna hai.
...
commands.weather = {
    ...
    async execute(sock, m, args, config) {
        ...
        try {
            const res = await axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${encodeURIComponent(city)}&appid=060a6bcfa19809c2cd4d97a212b19273
...
// ========== START BOT (Now that commands are defined) ==========
