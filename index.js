...
// ========== EXPRESS SERVER (Heroku health check) ==========
const app = express();
...
// ========== SESSION HANDLER (EXACTLY LIKE PAIR.JS) ==========
...
// ========== START BOT (EXACT CONFIG AS PAIR.JS) ==========
async function startBot() {
    const { state, saveCreds } = await useMultiFileAuthState(sessionDir);
    const { version } = await fetchLatestBaileysVersion(); // same as pair.js
