...
const APP_URL = process.env.APP_URL || 'https://necyyy-1633d37c9d33.herokuapp.com'; // اپنا لنک
...
// ========== AUTO-REACT (FIXED: No Spam) ==========
const reactedMessages = new Set(); // یاد رکھیں کہ کن میسجز پر ری ایکشن دے چکے ہیں
...
function setupAutoReact(sock) {
    sock.ev.on('messages.upsert', async (msg) => {
        try {
            ...
            // اگر یہ میسج پہلے ہی ری ایکشن ہے تو نظر انداز کریں
...
async function startBot() {
    ...
    sock.ev.on('messages.upsert', async (msg) => {
        try {
            ...
            // تمام ممکنہ ذرائع سے ٹیکسٹ نکالیں
